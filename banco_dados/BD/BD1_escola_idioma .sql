CREATE DATABASE  IF NOT EXISTS `escola_i` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `escola_i`;
-- MySQL dump 10.13  Distrib 8.0.42, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: escola_i
-- ------------------------------------------------------
...
CREATE TABLE `tb_avaliacao` (
  ...
  KEY `Fk_MATRICULA_AVALIACAO` (`FK_matricula`),
  CONSTRAINT `Fk_MATRICULA_AVALIACAO` FOREIGN KEY (`FK_matricula`) REFERENCES `tb_matricula` (`PK_matricula`),
...
CREATE TABLE `tb_pagamento` (
  ...
  KEY `Fk_MATRICULA_PAGAMENTO` (`FK_matricula`),
  CONSTRAINT `Fk_MATRICULA_PAGAMENTO` FOREIGN KEY (`FK_matricula`) REFERENCES `tb_matricula` (`PK_matricula`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_turma` (
  ...
  KEY `FK_MATRICULA_TURMA` (`FK_matricula`),
  ...
  CONSTRAINT `FK_MATRICULA_TURMA` FOREIGN KEY (`FK_matricula`) REFERENCES `tb_aluno` (`PK_aluno`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
-- Dump completed on 2025-07-04 16:38:12
